        ...
        <div className="page">
            ...
            <div className="grid grid-cols-3" style={{ gap: 'var(--space-lg)', marginBottom: 'var(--space-xl)' }}>
                <div className="glass-card" style={{ padding: 'var(--space-lg)', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                    <span style={{ color: 'var(--text-muted)', fontWeight: 600, textTransform: 'uppercase', fontSize: 'var(--font-size-sm)' }}>{t('finance:totalIncome')}</span>
                    <span style={{ fontSize: '2rem', fontWeight: 800, color: 'var(--success)' }}>₹{totalIncome.toLocaleString()}</span>
                </div>
                <div className="glass-card" style={{ padding: 'var(--space-lg)', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                    <span style={{ color: 'var(--text-muted)', fontWeight: 600, textTransform: 'uppercase', fontSize: 'var(--font-size-sm)' }}>{t('finance:totalExpenses')}</span>
                    <span style={{ fontSize: '2rem', fontWeight: 800, color: 'var(--danger)' }}>₹{totalExpense.toLocaleString()}</span>
                </div>
                <div className="glass-card" style={{ padding: 'var(--space-lg)', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                    <span style={{ color: 'var(--text-muted)', fontWeight: 600, textTransform: 'uppercase', fontSize: 'var(--font-size-sm)' }}>{t('finance:netProfit')}</span>
