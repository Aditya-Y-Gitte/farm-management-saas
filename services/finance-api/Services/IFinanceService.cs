...
{
    Task<(IEnumerable<IncomeDto> Items, int TotalCount, int TotalPages)> GetIncomesAsync(int page, int pageSize, DateTime? startDate = null, DateTime? endDate = null);
    ...
    Task<(IEnumerable<ExpenseDto> Items, int TotalCount, int TotalPages)> GetExpensesAsync(int page, int pageSize, DateTime? startDate = null, DateTime? endDate = null);
